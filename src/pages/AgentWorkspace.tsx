...
import { liveTranscript, customerProfile } from '../data/mockData';
      ...
      <div className="flex-1 p-6 grid grid-cols-12 gap-5 overflow-auto">
        ...
        <div className="col-span-5 space-y-4">
          ...
          <div className="bg-surface-700 rounded-xl border border-slate-700/50 p-5">
            ...
            />
            <button className="mt-2 px-4 py-1.5 bg-brand-600 hover:bg-brand-500 text-white text-sm rounded-lg transition-colors">
              Save Notes
            </button>
          </div>
        </div>
        ...
        <div className="col-span-4 space-y-4">
          <div className="bg-surface-700 rounded-xl border border-slate-700/50 p-5">
            ...
            <div className="flex gap-2 pt-3 border-t border-slate-600/50">
              <button className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-emerald-600/20 text-emerald-400 text-xs font-medium rounded-lg hover:bg-emerald-600/30 transition-colors">
                <UserCheck className="w-3.5 h-3.5" />
                Take Over from AI
              </button>
              <button className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-surface-600 text-slate-300 text-xs font-medium rounded-lg hover:bg-surface-500 transition-colors">
          ...
          <div className="bg-surface-700 rounded-xl border border-slate-700/50 p-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {['Schedule Callback', 'Send Email', 'Create Ticket', 'Add to Campaign'].map((action) => (
                <button
                  key={action}
